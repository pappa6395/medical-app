    ...
    <div>
        <div className='flex justify-between mt-2 border-b px-4 py-4'>
          <div className=''>
            ...
            >
            {`${appointment?.firstName || "Unknown"} ${appointment?.lastName || "Unknown"}`} 
            </h2>
        ...
        <div className="grid grid-cols-5 py-4 divide-x-2 divide-gray-200">
          ...
          >
            ...
            <p className='px-4'>{dob || "Unknown"}</p>
          </div>
        </div>
        <div className="py-4">
          ...
          <p className='px-3'>{appointment?.location || "Unknown"}</p>
          </div>
        </div>
        <div className="py-4">
          <div className="flex px-4 py-3 space-x-2 divide-x-2 
          ...
          <p className='px-3'>{appointment?.email || "Unknown"}</p>
          </div>
        </div>
        <div className="py-4">
          <div className="flex px-4 py-3 space-x-2 divide-x-2 
        ...
        {appointment?.status === "approved" ? (
          ...
          <div className=''>
            <UpdateAppointmentForm appointment={appointment ?? null} />
          </div>
        )}
    </div>
