  ...
  return (
    ...
    <div className={className}>
        <div className='max-w-6xl py-20 mx-auto px-8'>
            <SectionHeading title={title} className={isInPerson ? "text-slate-50" : "text-slate-700 dark:text-slate-50" }/>
            <div className='py-8 flex items-start md:items-center justify-between'>
                {isInPerson ? 
                (
                    <div className="overflow-hidden rounded-lg lg:col-span-2 h-auto mr-2">
                        <iframe 
