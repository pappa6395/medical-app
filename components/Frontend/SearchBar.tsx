          ...
          <div className="relative">
            <div className="flex items-center">
              <input
                ...
                value={query}
                className="block text-sm w-[360px] p-4 ps-10 text-gray-900 
              ...
              <button
                type="submit"
                className="text-white absolute translate-x-[280px]
                bg-blue-800 hover:bg-blue-800 focus:ring-4 focus:outline-none 
                focus:ring-blue-300 font-medium rounded-full text-sm px-4 py-3 
