...
const page = async ({params: paramsPromise}: PageProps) => {
    ...
    const appointments = (await getAppointmentByPatientId(id))?.data || []
    const patients = (await getRecentAppointmentByPatientId(id))?.data 

    const dob = patients?.dob as Date
    const formattedDob = format(dob, "PPP")
